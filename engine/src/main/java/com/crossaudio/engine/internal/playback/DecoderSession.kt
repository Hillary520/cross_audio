...
internal class DecoderSession(
    ...
    onSegmentFetched: (String, Long, Long) -> Unit = { _, _, _ -> },
    onAdaptiveBitrateRequest: (List<Int>, Long, Int?) -> Int? = { _, _, _ -> null },
    onAdaptiveSwitch: (String, Int?, String) -> Unit = { _, _, _ -> },
    ...
    private val decoder: DecoderBackend = if (
        ...
        SegmentBackend(
            SegmentTrackDecoder16(
                ...
                onAdaptiveBitrateRequest = onAdaptiveBitrateRequest,
                onAdaptiveSwitch = onAdaptiveSwitch,
